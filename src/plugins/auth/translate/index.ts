...
setBulk({
    en: {
        'auth.span.login': '登录',
        'auth.span.register': '注册',
        'auth.span.remember': '记住密码',
        'auth.span.bad.password': '账户或密码错误',
        'auth.span.register.error': '发生错误，请重试',
        'auth.span.email': '邮箱',
        'auth.span.password': '密码',
        'auth.span.password.again': '重复密码',
        'auth.span.new.user': '注册',
        'auth.span.existing.user': '登录',
