...
let verificationCodes: Record<string, { code: string; expirationTime: number }> = {};
let recoverVerificationCodes: Record<string, { code: string; expirationTime: number }> = {};
